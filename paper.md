...
Apicobasal polarization is a fundamental property of epithelial tissues, influencing processes such as progenitor proliferation and lumen formation. Manual scoring of apical polarity from fluorescence microscopy images is labor-intensive and subjective.  
...
Applied to real organoid datasets, the pipeline achieved **r = 0.98 correlation** with manual annotations and <4% mean absolute error, significantly reducing analysis time from minutes per organoid to seconds.
...
Our pipeline decouples parameter selection from user input, offering **high reproducibility**, **batch processing**, and **transparent code design** suitable for both experimental biologists and computational scientists.
...
- Convex hull area computation and polarity classification using a **distance ratio metric** (0 ≈ apical-out, 1 ≈ apical-in)
...
<!-- Add references from paper.bib here, e.g.:
[@schindelin2012fiji]: Schindelin, J., et al. (2012). "Fiji: an open-source platform for biological-image analysis." Nature methods 9.7: 676-682.
[@carpenter2006cellprofiler]: Carpenter, A.E., et al. (2006). "CellProfiler: image analysis software for identifying and quantifying cell phenotypes." Genome Biology 7.10: R100.
-->
